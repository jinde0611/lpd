...
rel='stylesheet' type='text/css'>
  ...
  <div class="page-content">  
    <div class="form-v10-content">
      <form class="form-detail" action="process\process_add_nomination.php?id=<?php echo $id ;?>" method="post" id="myform">
        <div class=" form-right">
          <h2>General Infomation</h2>
            <div class="form-row">
              <input type="text" name="title" id="title" class="input-text" value="<?php echo $row['t_name']; ?>" required disabled>
            </div>
            <div class="form-row">
              <input type="text" name="unit" id="unit" class="input-text" value="<?php echo $row['t_size']; ?> " required disabled>
            </div>
...
onblur="this.placeholder = 'Status'" disabled>
              </div>
              <div class="form-row form-row-2">
...
onblur="this.placeholder = 'Job Grade'" required>
              ...
              <input type="text" name="date" id="date"  value="<?php echo $row['t_date']; ?> "  disabled>

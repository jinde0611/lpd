...
--
-- Host: 127.0.0.1
-- Generation Time: Oct 09, 2019 at 06:28 PM
...
INSERT INTO `nominations` (`n_id`, `t_id`, `e_id`, `e_name`, `e_email`, `e_manager`, `job_grade`, `attendance`, `pre_score`, `post_score`, `total`, `timestamp`, `waitlist`) VALUES
(1, 1, 40460, 'Nishant Jinde', 'nishant.jinde@here.com', 'Bharat Shetty', '5 ', 'Present', 0, 0, 0, '2019-10-09 14:28:16.805580', 0),
(2, 1, 36819, 'Komal Pareek', 'komal.pareek@here.com', 'Dipti John', '5', 'Present', 0, 0, 0, '2019-10-09 14:28:23.935339', 0),
(3, 1, 40477, 'Priya Singh', 'priya.n.singh@here.com', 'Vinoth Veerabhu', '5 ', 'Present', 0, 0, 0, '2019-10-09 14:28:26.907507', 0),
...
(7, 4, 36830, 'Komal Pareek', 'komal.pareek@here.com', 'Dipti John', '5', 'Present', 0, 0, 0, '2019-10-09 14:23:53.985519', 0),
(8, 2, 40460, 'Nishant Jinde', 'nishantvjinde06@gmail.com', 'Bharat Shetty', '5', 'Present', 0, 0, 0, '2019-10-09 15:48:29.871183', 0);
...
(1, 'Negotiation And Persuasion Skills', '2019-09-28', '20', 'Active', 'Ganga', '2', '', 0),
(2, 'Customer Centricity', '2019-09-30', '22', 'Active', 'Brahmaputra', '3', '', 0),
(3, 'Attention to Detail', '2019-09-18', '22', 'Active', 'Big Ben', '2', '', 0),
(4, 'Communication With Impact', '2019-09-24', '25', 'Active', 'INS Prahar', '2', '', 0);
...
--
ALTER TABLE `nominations`
  MODIFY `n_id` int(15) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=12;
...
--
ALTER TABLE `training_detail`
  MODIFY `t_id` int(15) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=7;
